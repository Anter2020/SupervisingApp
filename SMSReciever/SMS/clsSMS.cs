    ...
    class clsSMS
    {
        ...
        public ShortMessageCollection ReadSMS(SerialPort port, string p_strCommand)
        {
            ...
            try
            {
                ...
                ExecCommand(port, "AT+CSCS=\"GSM\"", 300, "Failed to set character set.");
                // Select SIM storage
        ...
        public ShortMessageCollection ParseMessages(string input)
        {
            ...
            try
            {
                ...
                
                {
                    ...
                    string ch = "insert into alarmes (StationID,date,text) values('56', '" + DateTime.Parse(msg.Sent) + "','" + msg.Message +  "') ";
                    ...
                    catch (Exception e)
                    {
                        MessageBox.Show(e.Message);
                        x = 1;
                        //f.dataGridView.Rows[i].Cells[0].Value = "Not";
                        //f.dataGridView.Rows[i].Cells[1].Value = msg.Sender;
                        //f.dataGridView.Rows[i].Cells[2].Value = msg.Message;
                        //f.dataGridView.Rows[i].Cells[3].Value = "--";
                        //    f.dataGridView.Refresh();
                    ...
                    if (x == 0)
                    {
                        //f.dataGridView.Rows[i].Cells[0].Value = "ok";
                        //f.dataGridView.Rows[i].Cells[1].Value = msg.Sender;
                        //f.dataGridView.Rows[i].Cells[2].Value = msg.Message;
                        //f.dataGridView.Rows[i].Cells[3].Value = "--";
                        //f.dataGridView.Refresh();
